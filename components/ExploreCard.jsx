...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick}) => (
  ...
  >
    ...
    />
    {active !== id ? (
      <h3 className='font-semibold sm:text-[26px] text-[18px] text-black absolute z-0 
      ...
      '>
        ...
        <p className='font-normal text-[16px] leading-[20px] text-white uppercase'>Explore More</p>
