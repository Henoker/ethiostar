  ...
  <section className="bg-[#9fe218] text-black">
    <div className="container flex flex-col-reverse mx-auto lg:flex-row">
        ...
        <div className="flex space-x-2 sm:space-x-4">
          ...
          <div className="space-y-2">
            ...
            <p className="leading-snug">Transparent per-word pricing. No add-ons or down-payments.
              100% Money-back one-year guarantee!
            </p>
          </div>
        </div>
        <div className="flex space-x-2 sm:space-x-4">
      ...
      <div className="lg:w-1/2 xl:w-3/5">
        <div className="flex items-center rounded- justify-center p-4 md:p-8 lg:p-12">
          <img src="/atamember1.jpg" alt="" className="rounded-3xl shadow-lg bg-gray-500 sm:min-h-96" />
        </div>
