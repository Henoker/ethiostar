...
const AudioFeatures = () => (
	...
	<div className="container mx-auto space-y-12">
		...
		<div className="container text-white mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48">
            ...
            <a href="#contact">
            <button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Order Now</button>
            </a>
