...
const DtpHero = ()=> (
	...
	<div className="bg-[#B3FF17]">
		<div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-900">
			...
			<p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl text-gray-900">Look no further than our desktop publishing services! At Ethiostar America, we understand the importance of delivering high-quality translations that not only convey accurate information, but also make a positive impression on your target audience. That's why we offer desktop publishing services that can take your translated documents to the next level.</p>
