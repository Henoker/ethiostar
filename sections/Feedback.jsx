...
export default function Feedback() {
  ...
  async function submitHandler(data) {
    const recaptchaToken = await executeRecaptcha?.('feedback_page');
  ...
  //         </p>
  //       </div>
  //       <h1 className="mt-8 text-gray-400">Proud member of</h1>
  ...
  //         <img src="https://images.unsplash.com/photo-1485770958101-9dd7e4ea6d93?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzB8fGNvbnRhY3QlMjB1c3xlbnwwfHwwfHx8MA%3D%3D" alt="" />
  //         {/* {alertMessage && (
  ...
  //         </form> */}
    ...
    //   </div>
    // </div>
    <section className="theme-dark-blue bg-skin-fill">
      <div className="container px-6 py-12 mx-auto" id="contact">
