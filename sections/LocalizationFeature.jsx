...
const LocalizationFeature = () => (
  ...
  <div className="lg:flex lg:items-center">
    <div className="w-full space-y-12 lg:w-1/2 ">
      <div>
        ...
        Globalize Your Business with <br /> Our Website Localization Services
        </h1>
        <div className="mt-2">
      ...
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          <h1 className="text-xl font-semiboldcapitalize text-white">
          Reach a wider audience:
          </h1>
          <p className="mt-3 text-gray-100">
           Localizing your website will make it more accessible to people who speak different languages, increasing your potential customer base.
      ...
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          ...
          People are more likely to trust a website that is in their own language and reflects their culture. Improve your search engine rankings: Localized content can improve your website's visibility in search engines, making it easier for people to find you online.
          </p>
        </div>
      </div>
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          ...
          <p className="mt-3 text-gray-300">
          Localized content can improve your website's visibility in search engines, making it easier for people to find you online.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
    <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
      <svg
        className="h-12 fill-current text-gray-300"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 266 100"
      >
    ...
    <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
      <svg
        className="h-8 mt-2 fill-current text-gray-300"
        viewBox="0 0 398 120"
        xmlns="http://www.w3.org/2000/svg"
      >
        <g fillRule="nonzero">
    ...
    <div className="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
      <svg
        className="h-5 mt-1 fill-current text-gray-300"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <div className="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
      <svg
        className="h-8 fill-current text-gray-300"
...
<div className="container px-6 py-10 mx-auto">
  <h1 className="text-2xl font-semibold capitalize lg:text-3xl text-center text-white">
   Explore <br /> Our <span className="text-blue-500">Software Localization</span>
  </h1>
  <img
    className="min-w-full object-cover mt-12 h-64 md:h-[450px] rounded-xl overflow-hidden"
    src="https://images.unsplash.com/photo-1534972195531-d756b9bfa9f2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
  />
    ...
    <div className="p-6 border rounded-xl border-r-gray-200">
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          ...
          <p className="mt-3 text-gray-300">
          People are more likely to use software that is in their native 
          language and reflects their culture.
          </p>
        </div>
      </div>
    </div>
    <div className="p-6 border rounded-xl  border-r-gray-200">
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          ...
          <p className="mt-3 text-gray-300">
          Users will appreciate software that speaks their language and 
          reflects their cultural norms and values.
          </p>
        </div>
      </div>
    </div>
    <div className="p-6 border rounded-xl  border-r-gray-200">
      <div className="md:flex md:items-start md:-mx-4">
        ...
        <div className="mt-4 md:mx-4 md:mt-0">
          ...
          <p className="mt-3 text-gray-300">
          Localization can increase your market share and revenue by appealing to
          new customers who would not otherwise use your software.
          </p>
        </div>
      </div>
    </div>
...
<div className="container px-6 py-10 mx-auto">
  <h1 className="text-2xl font-semibold text-center capitalize lg:text-3xl text-white">
    Discover our <br /> Mobile and <span className="text-blue-500">app localization</span>
  </h1>
  <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
    <div className="flex flex-col items-center p-6 space-y-3 text-center rounded-xl  bg-[#B3FF17]">
      ...
      Mobile devices are ubiquitous and using mobile localization will help you reach more customers
       who prefer to use mobile devices for their daily activities.
      </p>
      <a
        href="#"
        className="flex items-center -mx-1 text-smcapitalize transition-colors duration-300 transform text-blue-400  hover:text-blue-500"
      >
    ...
    <div className="flex flex-col items-center p-6 space-y-3 text-center rounded-xl  bg-[#B3FF17]">
      ...
      <p className=" text-gray-900">
      Localization ensures that your mobile app is tailored to your target audience,
      making it easier for them to use and navigate.
      </p>
      <a
        href="#"
        className="flex items-center -mx-1 text-sm capitalize transition-colors duration-300 transform text-blue-400 hover:underline hover:text-blue-500"
      >
        <span className="mx-1">read more</span>
        <svg
          className="w-4 h-4 mx-1 rtl:-scale-x-100"
    ...
    <div className="flex flex-col items-center p-6 space-y-3 text-center rounded-xl bg-[#B3FF17]">
      ...
      <p className="text-gray-900">
      Providing localized content on mobile can help differentiate your 
      app from competitors who have not yet invested in localization.
      </p>
      <a
        href="#"
        className="flex items-center -mx-1 text-sm  capitalize transition-colors duration-300 transform text-blue-400 hover:text-blue-500"
      >
        <span className="mx-1">read more</span>
        <svg
          className="w-4 h-4 mx-1 rtl:-scale-x-100"
