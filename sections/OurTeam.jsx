  ...
  <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
    <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
      ...
      <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
        ...
        <div className="flex flex-col justify-center bg-white w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
          <img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="/EphiPhoto.jpg" />
          <div className="flex-1 my-4">
            <p className="text-xl font-semibold leading-snug">Epheson Tesfatsion</p>
