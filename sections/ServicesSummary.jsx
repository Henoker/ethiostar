...
<section className="py-6 dark:bg-gray-800 dark:text-gray-100">
	<div className="container p-4 mx-auto space-y-16 sm:p-10">
		...
		<div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
			<div className="space-y-4  bg-gray-200 pt-4 overflow-hidden rounded-lg border border-gray-100 shadow-sm">
				...
				<div className="flex flex-col items-center">
					...
					<p class="ml-4 mr-4 justify-center text-base leading-relaxed text-gray-900">Through a rigorous recruitment process and ongoing training, our network of linguists, reviewers, and subject matter experts (SME) ensure that we have the capacity to handle any volume and speed.</p>
					<div className="flex mt-2 space-x-2 pb-4">
                        ...
                        <button type="button" className="px-8 py-3 font-semibold rounded bg-gray-400 text-gray-800">
                            Read More
                        </button>
						</Link>
					</div>
